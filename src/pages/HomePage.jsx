import { SiCodeforces, SiFacebook, SiGithub, SiInstagram, SiKaggle, SiLeetcode, SiLinkedin } from "react-icons/si";
            ...
            <div className="flex flex-col md:flex-row justify-evenly md:justify-center items-center w-[100%] pt-[2%] flex-wrap min-h-[50dvh]">
                <div className="text-white font-poppins flex flex-col gap-3 pl-2">
                    ...
                    <div className="flex gap-2 text-white text-2xl">
                        ...
                        <a href="https://www.kaggle.com/ahmadamindw" target="_blank">
                            <SiKaggle className="transition-all duration-300 ease-in-out hover:cursor-pointer hover:scale-110" />
                        </a>
                    </div>
                </div>
